...
class TransformerModel(nn.Module):
    ...
    ## ntoken ==> len(src_vocab)
    ## ninp ==> d_emb
    ## n_head ==> num of multi_head_attention's heads
    ## n_hid ==> dimention of feed forward nn, first_layer=(ninp, nhid), second_layer=(n_hid, ninp)
    ## n_layer ==> num of encoder layers
    ## dropout ==> drop out of feed forward layer & positional encoding layer
    ## activation ==> activation function of feed forward layer
    ...
    def __init__(self, ntoken, ninp, nhead, nhid, nlayers, dropout=0.5,
        ...
        self.src_mask = None
        self.pos_encoder = PositionalEncoding(ninp, dropout) ## max_seq_len = 5000(default)
    ...
    def forward(self, src, has_mask=True):
        if has_mask:
            ...
            self.src_mask = None
        src = self.encoder(src) * math.sqrt(self.ninp) ## embedding + scaling
